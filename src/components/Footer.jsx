      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center space-y-4">
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
            <img src="/app_icon.png" alt="Savi" className="h-8 w-8 rounded-full" />
            <span className="text-xl font-bold">Ram-Savi</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://www.facebook.com/Savipalestine"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/savi.palestine?igsh=a2VjNm01b2FnMWhl"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors transform hover:scale-110"
          ...
          <p className="text-primary font-semibold">{t.palestine}</p>
        </div>
      </div>
    </footer>
  )
