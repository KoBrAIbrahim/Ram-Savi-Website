...
function SaviApp({ language }) {
  ...
  const content = {
    ar: {
      ...
      whatIsSaviText: 'Savi هو تطبيق تسويقي فلسطيني يوفر منصة سهلة الاستخدام تمكن المطاعم والمتاجر من عرض خصومات وعروض خاصة للعملاء الباحثين عن القيمة والجودة. التطبيق يعمل على نموذج قائم على الأداء.',
